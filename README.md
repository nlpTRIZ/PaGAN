...
A sentence-level analysis was performed, a contradiction is therefore a pair of sentences containing the parameters forming a contradiction. The sentences of the **first part of contradiction** contain the improved parameter. The class **second part of contradiction** gathers the sentences that contain the degraded parameter when the parameter from the **first part of contradiction** is improved.
